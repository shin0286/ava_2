...
public class TestpathReport implements INameRule, ITestpathReport {
    ...
    private String executionTestpath = "";

    public TestpathReport() {
    }

    public TestpathReport(String executionTestpath, String normlizeTestpath, IInputReport input,
    ...
    private String deleteBracket(String testpath) {
        testpath = testpath.replace(ITestpath.SEPARATE_BETWEEN_NODES + " } ", "");
        testpath = testpath.replace(ITestpath.SEPARATE_BETWEEN_NODES + " { ", "");
        testpath = testpath.replace("{ " + ITestpath.SEPARATE_BETWEEN_NODES + " ", "");
        testpath = testpath.replace(" " + ITestpath.SEPARATE_BETWEEN_NODES + " End", "");
        testpath = testpath.replace(" " + ITestpath.SEPARATE_BETWEEN_NODES + " ", ITestpath.SEPARATE_BETWEEN_NODES);
        return testpath;
    }
    ...
    @Override
    public String getExecutionTestpath() {
        return executionTestpath;
    }

    @Override
    public void setExecutionTestpath(String executionTestpath) {
        this.executionTestpath = executionTestpath;
    }
