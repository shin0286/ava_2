...
public interface ISettingv2 {
	...
	String CG_OVERVIEW_LEVEL = "CG_OVERVIEW_LEVEL";
	String CG_MARGIN_Y = "CG_MARGIN_Y";
	String CG_MARGIN_X = "CG_MARGIN_X";
	String MAX_CG_NODE_WIDTH = "MAX_CG_NODE_WIDTH";
	String MAX_CG_NODE_LINE = "MAX_CG_NODE_LINE";
