...
public class Settingv2 extends AbstractSetting {
	...
	public static void main(String[] args) {
		Settingv2.settingPath = "D:/ava/classes/artifacts/cft4cpp/test/setting.properties";
		Settingv2.create();
	}
	...
	public static void initialUnixOS() {
        ...
        getAttributes().put(TESTDATA_STRATEGY, ITestdataGeneration.TESTDATA_GENERATION_STRATEGIES.MARS + "");
	...
	public static void initialWindowOS() {
		...
		getAttributes().put(GNU_GCC_PATH, "D:/Dev-Cpp/MinGW64/bin/gcc.exe");
		getAttributes().put(GNU_GPlusPlus_NAME, "g++.exe");
		getAttributes().put(GNU_GPlusPlus_PATH, "D:/Dev-Cpp/MinGW64/bin/g++.exe");
		getAttributes().put(GNU_GENERAL, "D:/Dev-Cpp/MinGW64/bin");
		getAttributes().put(GNU_MAKE_NAME, "mingw32-make.exe");
		getAttributes().put(GNU_MAKE_PATH, "D:/Dev-Cpp/MinGW64/bin/mingw32-make.exe");
