...
public abstract class TestdriverGeneration implements ITestdriverGeneration {
    ...
    protected String generateInstrumentedFunction() {
        ...
        if (typeofCoverage == IFunctionConfig.BRANCH_COVERAGE || typeofCoverage == IFunctionConfig.STATEMENT_COVERAGE)
            fnInstrumentation = new FunctionInstrumentation(getFunction());
        else if (typeofCoverage == IFunctionConfig.SUBCONDITION)
